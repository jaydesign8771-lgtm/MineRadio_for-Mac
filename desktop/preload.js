...
contextBridge.exposeInMainWorld('desktopWindow', {
  ...
  pickLocalMusicFolders: () => ipcRenderer.invoke('mineradio-pick-local-music-folders'),
  scanLocalMusicFolders: (folderPaths) => ipcRenderer.invoke('mineradio-scan-local-music-folders', folderPaths || []),
